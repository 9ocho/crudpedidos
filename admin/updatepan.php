...
<body id="page-top">
  ...
  <header class="masthead bg-ligth text-secondary text-center">
      <!-- Masthead Heading -->
      <h2 class="text-uppercase text-secondary">Actualizar pan</h2>
      <!-- Icon Divider -->
    ...
    <div class="container text-center">
        <?php
            ...
            if(isset($_GET['id'])){
                $id = $_GET['id'];
                $query = "SELECT * FROM panes WHERE id_p = $id";
        ...
        <div class="d-flex flex-column align-items-center ">
            ...
            <button class="btn btn-success" name="updatepan">Actualizar</button>
            </form>
        </div>
    </div>
  </header>
