...
<body id="page-top">
  ...
  <header class="masthead bg-ligth text-secondary text-center">
      ...
      <h2 class="text-uppercase text-secondary">Salsas</h2>
            ...
            <tbody>
                ...
                while($row = mysqli_fetch_array($result_alumnos)){?>
                    <tr>
                        ...
                        <td><?php echo $row['precio_s']?></td>
                        <td>
                            <a href="updatesalsa.php?id=<?php echo $row['id_s']?>">
                            <button type="button" class="btn btn-warning" name="update">Modificar</button>
                            <a href="delete.php?idsalsa=<?php echo $row['id_s']?>">
