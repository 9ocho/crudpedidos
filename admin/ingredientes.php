...
<body id="page-top">
  ...
  <header class="masthead bg-ligth text-secondary text-center">
      ...
      <h2 class="text-uppercase text-secondary">Ingredientes</h2>
            ...
            <tbody>
                ...
                while($row = mysqli_fetch_array($result_alumnos)){?>
                    <tr>
                        ...
                        <td><?php echo $row['precio_i']?></td>
                        <td>
                            <a href="updateing.php?id=<?php echo $row['id_i']?>">
                            <button type="button" class="btn btn-warning" name="update">Modificar</button>
                            <a href="delete.php?idingrediente=<?php echo $row['id_i']?>">
