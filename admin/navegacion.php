...
<div class="container">
    <a class="navbar-brand js-scroll-trigger" href="admin.php">Crud pedidos</a>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger text-white" href="admin.php">Inicio</a>
        </li>
        <li class="mx-0 mx-lg-1">
